...
#define Contrain_Height_I 12000
...
//  float yawControlDelay = 0.7f;//偏航角的控制延时平滑
  ...
  while(DEF_ON)
  {
    ...
    {
      uavData.motorPwm[0] = 800;
      uavData.motorPwm[1] = 800;
      uavData.motorPwm[2] = 800;
      uavData.motorPwm[3] = 800;
...
//      attitudeStateClear();
    }else if( (uavData.uavStatue == UAV_STATUE_ATTITUDE) || (uavData.uavStatue == UAV_STATUE_ALTITUDE) || (uavData.uavStatue == UAV_STATUE_POSITION))
    {
      ...
      {
        uavData.refAngle[0] = (uavData.receriverValue[0] - 1420) * (0.05f) + 0.6f;
        uavData.refAngle[1] = (uavData.receriverValue[1] - 1420) * (0.05f) + 1.5f;
      }
      
      if((uavData.uavStatue == UAV_STATUE_ATTITUDE) || (uavData.uavStatue == UAV_STATUE_ALTITUDE))
      {
        if(DEF_ABS(uavData.receriverValue[3] - 1420) > 30)
        {
          uavData.refAngle[2] = uavData.refAngle[2] - (uavData.receriverValue[3] - 1420) * 0.002f;
        }
      }
...
//              
        ...
        */
        ...
        //油门
        //controlValue[3] = uavData.receriverValue[2];
